...
#' Constuctor for the VCF_Lumpy_v4.1 sub-class
#' 
#' @name VCF_Lumpy_v4.1
#' @rdname VCF_Lumpy_v4.1-class
...
VCF_Lumpy_v4.1 <- function(vcfData, vcfHeader, paired, tumorColumn) {
    ...
    new("VCF_Lumpy_v4.1", description=finalDescription, sample=sample, 
