...
#' @name format_cytobands
#' @param data_frame a data frame retrieved from UCSC giving cytogenetic information
#' @param chromosome character string specifying chromosome of interest from UCSC data frame
#' @return object of class data frame

format_cytobands <- function(data_frame, chromosome)
{
