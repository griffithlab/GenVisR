                                ...
                                plot_label_angle=0)
{
    ...
    if(!is.null(plot_palette))
    {
        ...
        palette <- c("#ff0000", "#FF581A", "#FF581A", "#ff0000", "#9400D3",
                     "#ff0000", "#ffd700", "#ff69b4", "#ff69b4", "#ff69b4",
                     "#ffd700", "#FF0080", "#ff7f50", "#ff00ff", "#76ee00", 
                     "#76ee00", "#458b00", "#458b00", "#7ac5cd", "#7ac5cd",
                     "#32cd32", "#02599c", "#ff4500", "#32cd32", "#a2b5cd",
                     "#a2b5cd", "#a52a2a", "#a52a2a", "#a52a2a", "#a52a2a",
                     "#a52a2a", "#7f7f7f", "#a52a2a", "#7f7f7f", "#636363")
