...
mutSpec.mutation_sample_subset <- function(x, samples)
{
    ...
    {
        warning("argument supplied to main.samples is not a character vector, attempting to coerce")
    ...
    {
        message("Detected one or more samples supplied to main.samples not found in x ... adding samples to plot")
    ...
    # Subset the data based on the arguments supplied in main.samples, then relevel the data frame
