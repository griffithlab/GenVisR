...
#' Constuctor for the VCF_Manta_v4.2 sub-class
#' 
#' @name VCF_Manta_v4.2
#' @rdname VCF_Manta_v4.2-class
...
VCF_Manta_v4.2 <- function(vcfData, vcfHeader, paired, tumorColumn) {
    ...
    new("VCF_Manta_v4.2", description=finalDescription, sample=sample, 
