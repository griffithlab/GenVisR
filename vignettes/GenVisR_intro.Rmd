...
library(knitr)
kable(data.frame("MAF"=c("nonsense", "frame_shift_del",
...
kable(data.frame("MGI"=c("Nonsense_Mutation", "Frame_Shift_Ins",
...
# Call genCov
genCov(data, txdb, gr, genome, gene_labelTranscriptSize=5)
```
