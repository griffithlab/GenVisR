...
### lohView
lohView provides a method for visualizing LOH from a multi sample and multi chromosome perspective. Input consists of a data frame with column names "chromosome", "position", "n_freq", "t_freq", and "sample".
